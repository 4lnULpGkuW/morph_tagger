...
CHECKPOINTS_FILEPATH = './checkpoints'
DATA_INFO_FILEPATH = './data' # Место сохранения метрик валидации и обучения

DATASET_TO_PREPARE = 'syntagrus' # taiga, syntagrus of merged
